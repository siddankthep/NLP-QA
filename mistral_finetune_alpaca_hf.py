...
# Without unslothai because Dr. Linh's server had GPU with compute capability 7.5, unsloth requires 8.0
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    use_cache=False,
    token="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",
)

tokenizer = AutoTokenizer.from_pretrained(
    "mistralai/Mistral-7B-v0.1", token="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"
)
...
if False:
    model.push_to_hub_merged(
        ...
        tokenizer,
        save_method="merged_16bit",
        token="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",
    )
